...
{
    public class WinUniversalPlatform : IPlatform
    {
        public string Name { get { return "WinUniversal"; } }
		...
		{
			throw new NotSupportedException ("WinUniversal cannot load images from file paths. Use the Stream overload instead.");
		}
